...
export default function Header({ room, onlineUsers, onSettingsClick }) {
  ...
  return (
    <header className="bg-blue-600 text-white p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-2 text-xl">
      ...
      <div className="text-center w-full md:w-auto">
        <span className="text-sm bg-white text-blue-600 rounded-full px-4 py-1">
          {typeof room === 'string' && room.trim() !== '' ? `Room: ${room}` : 'No room selected'}
        </span>
      </div>
